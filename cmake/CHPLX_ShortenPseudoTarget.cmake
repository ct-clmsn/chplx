...
function(shorten_chplx_pseudo_target target shortened_target)
  chplx_debug("shorten_chplx_pseudo_target" "shortening pseudo target: ${target}")
  if(WIN32)
    set(args)
    foreach(arg ${target})
      # convert to a list
    ...
    chplx_debug("shorten_chplx_pseudo_target"
