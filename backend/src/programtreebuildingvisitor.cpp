...
struct VariableVisitor {
   ...
   void operator()(byte_kind const&) {
      curStmts.push_back(ScalarDeclarationExpression{{{scopePtr}, identifier, byte_kind{}, emitChapelLine(ast)}});
   }
   void operator()(bool_kind const&) {
      curStmts.push_back(ScalarDeclarationExpression{{{scopePtr}, identifier, bool_kind{}, emitChapelLine(ast)}});
   }
   void operator()(int_kind const&) {
      curStmts.push_back(ScalarDeclarationExpression{{{scopePtr}, identifier, int_kind{}, emitChapelLine(ast)}});
   }
   void operator()(real_kind const&) {
      curStmts.push_back(ScalarDeclarationExpression{{{scopePtr}, identifier, real_kind{}, emitChapelLine(ast)}});
   }
   void operator()(complex_kind const&) {
      curStmts.push_back(ScalarDeclarationExpression{{{scopePtr}, identifier, complex_kind{}, emitChapelLine(ast)}});
   }
   void operator()(string_kind const&) {
      curStmts.push_back(ScalarDeclarationExpression{{{scopePtr}, identifier, string_kind{}, emitChapelLine(ast)}});
   }
   ...
   void operator()(std::shared_ptr<array_kind> const& t) {
      curStmts.push_back(ArrayDeclarationExpression{{{scopePtr}, identifier, t, emitChapelLine(ast)}});
   }
...
struct VariableLiteralVisitor {
   ...
   void operator()(byte_kind const&) {
      curStmts.push_back(ScalarDeclarationLiteralExpression{{{scopePtr}, identifier, byte_kind{}, emitChapelLine(ast)}});
   }
   void operator()(bool_kind const&) {
      curStmts.push_back(ScalarDeclarationLiteralExpression{{{scopePtr}, identifier, bool_kind{}, emitChapelLine(ast)}});
   }
   void operator()(int_kind const&) {
      curStmts.push_back(ScalarDeclarationLiteralExpression{{{scopePtr}, identifier, int_kind{}, emitChapelLine(ast)}});
   }
   void operator()(real_kind const&) {
      curStmts.push_back(ScalarDeclarationLiteralExpression{{{scopePtr}, identifier, real_kind{}, emitChapelLine(ast)}});
   }
   void operator()(complex_kind const&) {
      curStmts.push_back(ScalarDeclarationLiteralExpression{{{scopePtr}, identifier, complex_kind{}, emitChapelLine(ast)}});
   }
   void operator()(string_kind const&) {
      curStmts.push_back(ScalarDeclarationLiteralExpression{{{scopePtr}, identifier, string_kind{}, emitChapelLine(ast)}});
   }
   void operator()(template_kind const&) {
   }
   void operator()(range_kind const&) {
   ...
   switch(ast->tag()) {
    ...
    case asttags::Variable:
    {
       ...
       if(varsym && !varsym->literal) {
          std::visit(
             VariableVisitor{scopePtr, identifier, curStmts, br, ast},
             *varsym->kind
          );
       }
       else if(varsym && varsym->literal) {
          std::visit(
             VariableLiteralVisitor{scopePtr, identifier, curStmts, br, ast},
             *varsym->kind
          );
       }
    }
