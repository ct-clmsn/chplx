...
static void generateSourceHeader(std::ostream & fos, std::string const& fps, std::string const& chplFilePathStr) {
   fos << "// This program file was generated by the chplx compiler." << std::endl;
   fos << "// The original Chapel program file can be found here: " << chplFilePathStr << std::endl; 
   fos << "//" << std::endl;
...
int main(int argc, char ** argv) {
   ...
   if(numErrors > 0) {
      ...
      generateSourceHeader(ofs, ofilePath, *filePath);
