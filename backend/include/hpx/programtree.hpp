...
struct ScalarDeclarationLiteralExpression
...
struct ArrayDeclarationLiteralExpression
    : public VariableDeclarationExpression {
...
struct TupleDeclarationLiteralExpression
    : public VariableDeclarationExpression {
  std::vector<uast::AstNode const *> literalValues;
  void emit(std::ostream &os) const;
};
...
using Statement = std::variant<
    std::monostate, std::shared_ptr<StatementList>, ScalarDeclarationExpression,
    ScalarDeclarationLiteralExpression, ArrayDeclarationExpression,
    ArrayDeclarationLiteralExpression, TupleDeclarationExpression,
    TupleDeclarationLiteralExpression, LiteralExpression, VariableExpression,
    std::shared_ptr<UnaryOpExpression>, std::shared_ptr<BinaryOpExpression>,
    std::shared_ptr<TernaryOpExpression>, std::shared_ptr<ScopeExpression>,
